...
export default function index(): JSX.Element {
  return (
    <main className="section bg-transparent">
      ...
      <section className="mt-12 grid h-[35rem] w-full grid-cols-2 gap-10 bg-transparent px-10 text-white">
        ...
        <div className="relative flex h-full flex-col items-start justify-start gap-4 overflow-hidden rounded-lg border bg-transparent sm:p-4 md:shadow-xl">
          <p className="text-muted-foreground">
            ...
            During these three years, I not only received intensive training in
            Mathematics but also honed my logical thinking, analytical skills,
            and problem-solving abilities, building a solid foundation for my
            future development.
          </p>
          <p className="text-muted-foreground">
            ...
            This period allowed me to delve deeper into the field of information
            technology and set my goal to become a professional Web Developer.
            Driven by a strong passion for web design and development, I
            continuously strive to learn and refine my skills, aiming to create
            innovative and high-quality web solutions. This is my achievement
