    ...
    return (
        <div onMouseEnter={handleHover} onMouseLeave={handleHoverExit} className="overflow-hidden">
            ...
            <div className="relative mt-1 h-1 w-full">
                <div
                    className={cn(
                        "absolute left-0 top-0 h-full w-full bg-violet-500 transition-transform duration-300",
                        isHoveredIn
                ...
                <div
                    className={cn(
                        "absolute left-0 top-0 h-full w-full translate-x-0 transform bg-violet-500 opacity-0 transition-transform duration-300",
