            ...
            <div ref={ref} className="relative max-w-7xl mx-auto pb-20">
                {data.map((item, index) => (
                    ...
                    >
                        ...
                        <div className="relative pl-20 pr-4 md:pl-4 w-full">
                            <h3 className="md:hidden block text-xl mb-4 text-left font-bold text-gray-500 dark:text-gray-500">
                                {item.title}
                            </h3>
                            {item.content}{" "}
                        </div>
                ...
                >
                    <motion.div
                        ...
                        className="absolute inset-x-0 top-0  w-[2px] bg-gradient-to-t from-purple-500 via-violet-300 to-transparent from-[0%] via-[10%] rounded-full"
                    />
                </div>
            </div>
        </div>
